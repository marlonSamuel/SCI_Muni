      ...
      self.$refs["ruleForm"].validate(valid => {
        ...
        self.$store.state.services.categoriaAlmacenService
          ...
          .then(r => {
            ...
            if (categoria.id > 0) {
              self.message("Categoria Almacen actualizado correctamente", "success");
            } else {
              self.message("Categoria Almacen insertado correctamente", "success");
            }
          })
          .catch(r => {});
      });
